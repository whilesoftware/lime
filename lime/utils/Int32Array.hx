...
@:forward() @:generic @:arrayAccess abstract Int32Array(ArrayBufferView) from ArrayBufferView to ArrayBufferView {
	...
	public function subarray (begin:Int, end:Null<Int> = null):Int32Array {
		
		if (end == null) end == this.length;
		return new Int32Array (this.buffer, begin << 2, end - begin);
	...
	@:noCompletion @:arrayAccess public inline function __get (index:Int):Null<Int> {
		...
		#if cpp
		untyped return __global__.__hxcpp_memory_get_i32 (this.buffer.getData (), index + this.byteOffset);
		#else
	...
	@:noCompletion @:arrayAccess public inline function __set (index:Int, value:Int):Int {
		...
		#if cpp
		untyped __global__.__hxcpp_memory_set_i32 (this.buffer.getData (), index + this.byteOffset, value);
		#else
		this.buffer.position = index + this.byteOffset;
		this.buffer.writeInt (Std.int (value));
		#end
		return value;
